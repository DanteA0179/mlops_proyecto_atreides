...
def load_parquet_to_table(
    conn: duckdb.DuckDBPyConnection, parquet_path: str, table_name: str, replace: bool = True
) -> None:
    """
...
def query_to_dataframe(
    conn: duckdb.DuckDBPyConnection, query: str, output_format: str = "polars"
...
def load_data(
    conn: duckdb.DuckDBPyConnection, cleaned_parquet: str = "data/processed/steel_cleaned.parquet"
) -> None:
    """
