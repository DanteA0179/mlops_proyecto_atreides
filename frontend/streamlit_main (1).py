...
with tab2:
    st.info(
        "👉 Por favor, navega a la página **'🔮 Predicción'** en la barra lateral para realizar predicciones."
    )
    st.markdown(
        """
...
with tab3:
    st.info(
        "👉 Por favor, navega a la página **'💬 Copiloto IA'** en la barra lateral para chatear con el asistente."
    )
    st.markdown(
        """
